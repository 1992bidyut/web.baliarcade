...
@section('admin_content')
	<div class="content-header">
		<div class="container-fluid">
			<div class="row mb-2">
				<div class="col-sm-6">
					<h1 class="m-0 text-dark">All Advertisement</h1>
				</div><!-- /.col -->
				<div class="col-sm-6">
		...
		<div class="container-fluid">
			...
			<div class="card">
				<div class="card-header bg-info">
					<h3 class="card-title">All Advertisement</h3>
					...
					<table id="example1" class="table table-bordered table-striped">
						...
						@foreach($advertises as $advertise )
							<tr>
								...
								<td><img src="{{$advertise->image}}" width="140px" height="100px"  alt=""></td>
								<td>{{$advertise->created_at->diffForHumans()}}</td>
								<td>
                                    <a href="#"  data-toggle="modal" data-target="#deleteAdvertisement" class="btn btn-sm btn-danger">x</a>
                                    <!-- Modal -->
                                    <div class="modal fade" id="deleteAdvertisement" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <a href="{{route('advertisement.destroy',$advertise->id)}}" class="btn btn-danger">Yes</a>
                                            </div>
                                        </div>
                                        </div>
                                    </div>
