			  						...
			  						<div class="col-md-6">
			  							...
			  							<div class="form-group">
			               	 			 ...
			               	 			 <div class="form-group">
			  								...
			  								<input type="text" name="name_en" id="name_en" class="form-control @error('name_en') is-invalid @enderror" placeholder="Enter Menu English" value="{{ old('name_en') }}">
			  							</div>
			  							@error('name_en')
			               	      			<div class="alert alert-danger">{{ $message }}</div>
			               	 			 @enderror
			               	 			 ...
			               	 			 <div class="form-group">
			  								...
			  								<input type="text" name="price_en" id="price_en" class="form-control @error('price_en') is-invalid @enderror" placeholder="Enter Menu Price English" value="{{ old('price_en') }}">
			  							</div>
			  							@error('price_en')
			               	      			<div class="alert alert-danger">{{ $message }}</div>
			               	 			 @enderror
				               	 		...
				               	 		<div class="form-group">
				  							...
				  							<input type="text" name="discount_en" id="discount_en" class="form-control @error('discount_en') is-invalid @enderror" placeholder="Enter Menu Discount English" value="{{ old('discount_en') }}">
				  						</div>
				  						@error('discount_en')
				               	      		<div class="alert alert-danger">{{ $message }}</div>
				               	 		@enderror
			  							...
			  							@error('menucategory_id')
			               	 			 ...
			               	 			 @enderror
				               	 			 <div class="form-group">
				  								...
				  								<input type="text" name="name_bn" id="name_bn" class="form-control @error('name_bn') is-invalid @enderror" placeholder="Enter Menu Name Bangla" value="{{ old('name_bn') }}">
				  							</div>
				  							@error('name_bn')
				               	      			<div class="alert alert-danger">{{ $message }}</div>
				               	 			@enderror
				               	 			<div class="form-group">
				  								...
				  								<input type="text" name="price_bn" id="price_bn" class="form-control @error('price_bn') is-invalid @enderror" placeholder="Enter Menu Price Bangla" value="{{ old('price_bn') }}">
				  							</div>
				  							@error('price_bn')
				               	      			<div class="alert alert-danger">{{ $message }}</div>
				               	 			@enderror
