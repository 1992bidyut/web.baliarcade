			  					...
			  					<div class="row">
			  						...
			  						<div class="col-md-6">
			               	 			 ...
			               	 			 <div class="form-group">
			  								...
			  								<input type="text" name="name_en" id="name_en" class="form-control @error('name_en') is-invalid @enderror" placeholder="Enter Restaurant Name English" value="{{ old('name_en') }}">
			  							</div>
			  							@error('name_en')
			  							...
			  							@error('restaurantcategory_id')
			               	 			 ...
			               	 			 <div class="form-group">
			  								...
			  								<input type="text" name="phone_en" id="phone_en" class="form-control @error('phone_en') is-invalid @enderror" placeholder="Enter Restaurant phone English" value="{{ old('phone_en') }}">
			  							</div>
			  							@error('phone_en')
			               	      			<div class="alert alert-danger">{{ $message }}</div>
			               	 			 @enderror
			  							...
			  							@error('description_en')
			               	 			 ...
			               	 			 <div class="form-group">
			  								...
			  								<input type="text" name="owner_en" id="owner_en" class="form-control @error('owner_en') is-invalid @enderror" placeholder="Enter shop phone English" value="{{ old('owner_en') }}">
			  							</div>
			  							@error('owner_en')
			               	      			<div class="alert alert-danger">{{ $message }}</div>
			               	 			 @enderror
			               	 			<div class="form-group">
			  								...
			  								<input type="text" name="ratting_en" id="owner_en" class="form-control @error('ratting_en') is-invalid @enderror">
			  							</div>
			  							@error('ratting_en')
			               	      			<div class="alert alert-danger">{{ $message }}</div>
			               	 			 @enderror
			  						...
			  						<div class="col-md-6">
			  							<div class="form-group">
			  								...
			  								<input type="text" name="name_bn" id="name_bn" class="form-control @error('name_bn') is-invalid @enderror" placeholder="Enter Restaurant Name Bangla" value="{{ old('name_en') }}">
			  							</div>
			  							@error('name_bn')
			               	      			<div class="alert alert-danger">{{ $message }}</div>
			               	 			 @enderror
			  							...
			  							@error('floor_id')
			               	 			 ...
			               	 			 <div class="form-group">
			  								...
			  								<input type="text" name="phone_bn" id="phone_bn" class="form-control @error('phone_bn') is-invalid @enderror" placeholder="Enter Restaurant Phone Bangla" value="{{ old('phone_en') }}">
			  							</div>
			  							@error('phone_bn')
			               	      			<div class="alert alert-danger">{{ $message }}</div>
			               	 			 @enderror
			  							...
			  							@error('description_bn')
			               	 			 ...
			               	 			 <div class="form-group">
			  								...
			  								<input type="text" name="owner_bn" id="owner_bn" class="form-control @error('owner_bn') is-invalid @enderror" placeholder="Enter Restaurant Owner Name Bangla" value="{{ old('owner_bn') }}">
			  							</div>
			  							@error('owner_bn')
			               	      			<div class="alert alert-danger">{{ $message }}</div>
			               	 			 @enderror
			               	 			 ...
			               	 			 <div class="form-group">
			  								...
			  								<input type="text" name="open" id="open" class="form-control @error('open') is-invalid @enderror" placeholder="Enter Restaurant open time" value="{{ old('open') }}">
			  							</div>
			  							@error('open')
			               	      			<div class="alert alert-danger">{{ $message }}</div>
			               	 			 @enderror
